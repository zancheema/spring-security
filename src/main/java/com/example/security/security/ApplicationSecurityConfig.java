...
import com.example.security.jwt.JwtTokenVerificationFilter;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAfter(new JwtTokenVerificationFilter(secretKey, jwtConfig), JwtUsernamePasswordAuthenticationFilter.class)
                .authorizeRequests()
